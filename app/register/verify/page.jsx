    ...
    const verifyEmail = async () => {
      try {
        const response = await fetch(
          `${process.env.NEXT_PUBLIC_BASE_URL}/auth/register-verify?token=${token}`,
          {
            method: 'GET',
            headers: {
      ...
      <div className="svm_box">
        {loading ? (
          ...
          <div className="svm_error">
            ...
            <p>
              Verification link is expired, click button below to resend the
              verification link
            </p>
            <button
              className="green_btn"
          ...
          <div className="svm_success">
            ...
            <button className="green_btn" onClick={() => router.push('/login')}>
              Login
            </button>
          </div>
        )}
