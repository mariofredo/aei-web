                    ...
                    <>
                                        ...
                                        <tr key={leaderData.id}>
                                            ...
                                            <td>
                                                <div className="action_btn">
                                                    <div className="delete_btn" onClick={() => handleDeleteLeaderClick(leaderData.id)}>Delete</div>
                                                    <div className="edit_btn" onClick={() => handleEditLeaderClick(leaderData)}>Edit</div>
                                                </div>
                                            </td>
                                        </tr>
                                    ))}
                        ...
                        <div className="section_table_box">
                            <div className="stb_ctr">
                                <h3>PIC</h3>
                                <div
                                    className={`add_more_btn ${picData.length >= 3 ? 'disabled' : ''}`}
                                ...
                                <tbody>
                                    {picData?.map((picData) => (
                                        <tr key={picData.id} >
                                            ...
                                            <td>
                                                <div className="action_btn">
                                                    <div className="delete_btn" onClick={() => handleDeleteClick(picData.id)}>Delete</div>
                                                    <div className="edit_btn" onClick={() => handleEditClick(picData)}>Edit</div>
                                                    <div 
    ...
    return (
        ...
        <div className="section_homepage">
            ...
            <div className="container">
             ...
             {companyData?.status === 'data_submitted' && <ModalRegistrationSuccess company={companyData?.companyName} /> }
        </div>
        {showPopup && (
            <ModalChangePassword
                showPopup={showPopup}
        ...
        {showPopupPic && (
            <ModalPic
                setShowPopupPic={setShowPopupPic}
