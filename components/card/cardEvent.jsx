            ...
            {events.map((event, index) => (
                <div className="card_event">
                    <div className="card_image">
                        <Link href={`/event/${event.slug}`}><Image src={event.imageCover} alt={event.title} width={270} height={185} /></Link>
                        {event.type === 'paid' ? (
                    ...
                    <div className="card_info">
                        <div className="event_title"><Link href={`/event/${event.slug}`}>{event.title}</Link></div>
                    ...
                    <div className="card_btn">
                        {event.paidStatus === 'paid' ? (
                            ...
                            <Link className="green_btn" href={`/event/${event.slug}`}>Join Seminar</Link>
                        )}
                    </div>
                </div>
            ))}
